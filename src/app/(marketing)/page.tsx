      ...
      <section className="border-t border-hairline">
        <div className="mx-auto max-w-[1200px] px-6 py-24">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-cards border border-hairline p-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {BANKS.map((bank) => (
              <Link
                ...
                className="rounded-cards border border-hairline px-4 py-3 text-body-sm font-medium text-ink hover:bg-ledger"
              >
                {bank.name}
      ...
      <section className="border-t border-hairline">
        <div className="mx-auto max-w-[1200px] px-6 py-24">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {FORMATS.map((format) => (
              <div key={format.slug} className="rounded-cards border border-hairline p-6">
